...
public class DifficultQuestion {
    ...
    public DifficultQuestion() {
        ...
        String options[][] = {
                ...
                {"A. Speed of light in vacuum to speed of light in the medium", "B. Speed of light in medium to speed of light in vacuum", "C. Wavelength in vacuum to wavelength in medium", "D. Frequency in vacuum to frequency in medium"},
                {"A. Specific heat", "B. Latent heat of fusion", "C. Latent heat of vaporization", "D. Sensible heat"},
                ...
                {"A. The focal length increases", "B. The focal length decreases", "C. The object distance increases", "D. The image distance decreases"},
                {"A. 5 kg", "B. 16 kg", "C. 24 kg", "D. 80 kg"},
                {"A. Between the pole and focus", "B. At the focus", "C. Between focus and centre of curvature", "D. At infinity"},
                ...
                {"A. Greater than the largest resistor", "B. Less than the smallest resistor", "C. Equal to the sum of all resistors", "D. Equal to the average of all resistors"}
        };
